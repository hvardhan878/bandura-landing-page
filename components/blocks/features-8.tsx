            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                ...
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-zinc-900 border-white/10">
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-zinc-900 border-white/10">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                                    <svg className="m-auto h-fit w-24 text-zinc-400" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            ...
                                            fill="currentColor"
                                        />
                                        <path className="text-purple-500" d="M3 72H209" stroke="currentColor" strokeWidth="6" strokeLinecap="round" />
                                    </svg>
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-white">Secure by design</h2>
                                    <p className="text-gray-400 text-sm">Enterprise-grade encryption and access controls. Your bid intelligence never leaves your private environment.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-zinc-900 border-white/10">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="text-purple-500 w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path
                                            ...
                                            fill="url(#paint0_linear_features8)"
                                        />
                                        <path
                                            stroke="currentColor"
                                            strokeWidth="3"
                                        ...
                                        />
                                        <defs>
                                            <linearGradient id="paint0_linear_features8" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-white">Weeks of research in hours</h2>
                                    <p className="text-gray-400 text-sm">Bandura synthesises procurement data, competitor filings, and prior submissions at machine speed.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-zinc-900 border-white/10">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-white">Competitive intelligence built in</h2>
                                        <p className="text-gray-400 text-sm">Automatically surface competitor positions, past awards, and pricing signals to sharpen your strategy months before submission.</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-lg relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/10 p-6 py-6 sm:ml-6">
                                    ...
                                    <svg className="w-full sm:w-[150%] text-purple-500" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            fillRule="evenodd"
                                            clipRule="evenodd"
                                            ...
                                            fill="url(#paint0_linear_features8_2)"
                                        />
                                        <path
                                            stroke="currentColor"
                                            strokeWidth="2"
                                        ...
                                        />
                                        <defs>
                                            <linearGradient id="paint0_linear_features8_2" x1="0.85108" y1="0.947876" x2="0.85108" y2="230.114" gradientUnits="userSpaceOnUse">
                                                <stop stopColor="#a855f7" stopOpacity="0.2" />
                                                <stop offset="1" stopColor="#a855f7" stopOpacity="0.01" />
                                            </linearGradient>
                                        </defs>
                                    </svg>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-zinc-900 border-white/10">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-white">Your whole team, aligned</h2>
                                        <p className="text-gray-400 text-sm">Capture decisions, share intelligence briefings, and assign review tasks — all in one place so nothing falls through the cracks.</p>
                                    </div>
                                </div>
                                <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-white/10 sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-white/10 bg-white/5 px-2 py-1 text-xs text-white shadow-sm">Bid Lead</span>
                                            <div className="ring-black size-7 ring-4">
                                                <img className="size-full rounded-full object-cover" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=56&h=56&fit=crop&crop=face" alt="Team member" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-black size-8 ring-4">
                                                <img className="size-full rounded-full object-cover" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=56&h=56&fit=crop&crop=face" alt="Team member" />
                                            </div>
                                            <span className="block h-fit rounded border border-white/10 bg-white/5 px-2 py-1 text-xs text-white shadow-sm">Strategist</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-white/10 bg-white/5 px-2 py-1 text-xs text-white shadow-sm">Analyst</span>
                                            <div className="ring-black size-7 ring-4">
                                                <img className="size-full rounded-full object-cover" src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=56&h=56&fit=crop&crop=face" alt="Team member" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
